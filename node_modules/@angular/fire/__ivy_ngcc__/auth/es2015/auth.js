...
AngularFireAuth.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: AngularFireAuth, factory: function AngularFireAuth_Factory(t) { return new (t || AngularFireAuth)(ɵngcc0.ɵɵinject(FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(PLATFORM_ID), ɵngcc0.ɵɵinject(NgZone)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AngularFireAuth, [{
        type: Injectable
                ...
                type: Inject,
                args: [PLATFORM_ID]
            }] }, { type: NgZone }]; }, { constructor: [], auth: [], authState: [], user: [], idToken: [], idTokenResult: [] });;
