...
AngularFireStorage.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: AngularFireStorage, factory: function AngularFireStorage_Factory(t) { return new (t || AngularFireStorage)(ɵngcc0.ɵɵinject(FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(BUCKET, 8), ɵngcc0.ɵɵinject(PLATFORM_ID), ɵngcc0.ɵɵinject(NgZone)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AngularFireStorage, [{
        type: Injectable
                ...
                type: Inject,
                args: [PLATFORM_ID]
            }] }, { type: NgZone }]; }, { constructor: [], schedulers: [], keepUnstableUntilFirst: [], storage: [], ref: [], upload: [] });;
